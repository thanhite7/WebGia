...
Our project aims to develop a comprehensive web portal that provides users with up-to-date information on gold prices, exchange rates, and oil prices. The web portal will serve as a one-stop destination for users who are interested in monitoring and analyzing these key economic indicators.
...
1. **Clone the Repository:** Get started by cloning the repository to your local machine.
   ...
   ```
   https://github.com/thanhite7/WebGia.git
   ```

2. **Install Frontend Packages:** Navigate to the &quot;/src&quot; directory and install the required npm packages by executing the following command in your terminal:
...
- Raise an issue on the repository: [GitHub Repository](https://github.com/thanhite7/WebGia)
